...
jQuery('.face1 .tgl_radio label').click(function(e){
...
// jQuery('.face2 .checkbox_item_wrap_ja label').click(function(e){
// 	jQuery('.filter_widget.fl_w50').find('.form-group').removeClass('active_bg_color0');
// 	jQuery(this).parents('.filter_widget.fl_w50').find('.form-group').addClass('active_bg_color0');
// });
...
jQuery('.submit_popup_area .checkbox_item_wrap_ja label').click(function(e){
	jQuery('.filter_widget.fl_w50').find('.form-group').removeClass('active_bg_color0');
	jQuery(this).parents('.filter_widget.fl_w50').find('.form-group').addClass('active_bg_color0');
});
